...
----
$ git clone git@github.com:slemeur/test-0605
...
== More Information
You can learn more about this booster and rest of the vert.x runtime in the link:http://appdev.openshift.io/docs/vertx-runtime.html[vert.x Runtime Guide].